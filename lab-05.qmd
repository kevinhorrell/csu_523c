...
b.  Recipe (15) - Define a formula you want to use to predict
    **logQmean**. Describe in words why you are choosing this specific
    formula. Consult the downloaded PDF for the data to help you make
    this decision. Build a recipe that you feel handles the predictors
    chosen.
