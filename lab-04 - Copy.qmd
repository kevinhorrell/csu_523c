...
```{r}
r <- rast("C:/Users/horre/Desktop/csu_523c/data/landsat-c2/level-2/standard/oli-tirs/2016/025/031/LC08_L2SP_025031_20160926_20200906_02_T1/LC08_L2SP_025031_20160926_20200906_02_T1_SR_B1.TIF")

palo_r <- rast(files[1], files[2])

palo_r <- writeRaster(files, filename = 'C:/Users/horre/Desktop/csu_523c/data/palo_r', overwrite = TRUE)
```
